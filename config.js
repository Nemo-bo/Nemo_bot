const ownerNumber = ["595971959183@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '595971959183' 
...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DO Nemo_bot COM 434 COMANDOS, BATERIA: ${battery}`
}
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=595971959183:+595 971 959183\n' 
+ 'END:VCARD'
